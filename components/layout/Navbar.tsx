                    ...
                    <div className="grid grid-cols-2 gap-8">
                      <div className="relative h-48 bg-accent overflow-hidden group/promo">
                        ...
                        <div className="absolute right-0 top-0 h-full w-1/2">
                          <Image src="/images/products/invisible_grill_thumb.png" alt="Invisible Grill" fill className="object-cover opacity-80 group-hover/promo:scale-105 transition-transform duration-700" />
                        </div>
                      </div>
                      <div className="relative h-48 bg-[#0e2340] overflow-hidden group/promo">
                        ...
                        <div className="absolute right-0 top-0 h-full w-1/2">
                          <Image src="/images/products/mosquito_net_thumb.png" alt="Mosquito Net" fill className="object-cover opacity-80 group-hover/promo:scale-105 transition-transform duration-700" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="absolute top-[calc(100%+8px)] left-0 w-full bg-white border-b border-border-custom opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-custom-lg z-[1000] rounded-b-[5px]" style={{width: '860px', left: '-280px'}}>
                  ...
                  <div className="container py-12 mx-auto">
                    ...
                    <div className="grid grid-cols-6 gap-6 mb-12">
                      {[
                        { name: 'Invisible Grill', image: '/images/products/invisible_grill_thumb.png', slug: 'invisible-grill' },
                        { name: 'Bird Net', image: '/images/products/bird_net_nylon.png', slug: 'bird-net' },
                        { name: 'Mosquito Net', image: '/images/products/mosquito_net_thumb.png', slug: 'mosquito-net' },
                        { name: 'Security Mesh', image: '/images/products/aluminium_mesh_thumb.png', slug: 'security-mesh' },
                        { name: 'Zip Screen', image: '/images/products/zip_screen_thumb.png', slug: 'zip-screen' },
                        { name: 'HDPE Nets', image: '/images/products/bird_net_hdpe.png', slug: 'bird-net' },
                      ].map((item, idx) => (
                    ...
                    <div className="grid grid-cols-2 gap-8">
                      <div className="bg-[#eef3f8] p-8 flex items-center justify-between group/promo">
                        <div className="relative w-1/2 h-40">
                          <Image src="/images/products/aluminium_mesh_thumb.png" alt="Security Mesh" fill className="object-cover transition-transform duration-700 group-hover/promo:scale-105" />
                        </div>
                      ...
                      <div className="bg-[#eef3f8] p-8 flex items-center justify-between group/promo">
                        <div className="relative w-1/2 h-40">
                          <Image src="/images/products/zip_screen_thumb.png" alt="Zip Screen" fill className="object-cover transition-transform duration-700 group-hover/promo:scale-105" />
                        </div>
                        <div className="flex flex-col gap-3 w-1/2 pl-4">
