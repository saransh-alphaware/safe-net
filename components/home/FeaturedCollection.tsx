      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] md:h-auto lg:h-[800px]">
        <div className="relative min-h-[400px] lg:min-h-full">
          <div className="absolute inset-0">
             <Image src="/images/lounge_collection.png" alt="Lounge collection" fill className="object-cover" />
          </div>
        </div>
        <div className="flex items-center p-12 lg:p-24 bg-bg-secondary relative">
          <div className="w-full max-w-[400px]">
            <span className="text-sm font-bold uppercase text-secondary mb-2 block">Summer 2024</span>
            <h2 className="text-[48px] lg:text-[64px] leading-[0.9] font-extrabold mb-12 text-primary">Lounge <br />collection</h2>
            ...
            <div className="mt-12 pt-12 border-t border-border-custom flex gap-6 items-end">
              <div className="bg-white p-4 shadow-custom-sm">
                <Image src="/images/products/florence_compact.png" alt="Featured item" width={100} height={120} className="object-cover" />
              </div>
              <div className="flex-1">
                <h4 className="text-lg font-bold mb-1">Wooden cabinet</h4>
                <p className="text-sm text-text-secondary mb-4">$350.00 - $520.40</p>
