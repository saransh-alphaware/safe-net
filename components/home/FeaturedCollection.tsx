      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] md:h-auto lg:h-[800px]">
        <div className="relative min-h-[400px] lg:min-h-full">
          <div className="absolute inset-0">
             <Image src="/safe-net/images/catalog/page-10.png" alt="Motorised Zip Screen Collection" fill className="object-cover" />
          </div>
        </div>
          ...
          <div className="w-full max-w-[400px]">
            ...
            <div className="mt-12 pt-12 border-t border-border-custom flex gap-6 items-end">
              <div className="bg-white p-4 shadow-custom-sm">
                <Image src="/safe-net/images/products/zip_screen_thumb.png" alt="Zip Screen" width={100} height={120} className="object-cover" />
              </div>
