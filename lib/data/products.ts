...
export const products: Product[] = [
  {
    ...
    price: 65.00,
    originalPrice: 85.00,
    imageUrl: '/images/products/invisible_grill_wire_rope.webp',
    gallery: [
      '/images/products/invisible_grill_wire_rope.webp',
      '/images/products/invisible_grill_hero.webp',
      '/images/products/invisible_grill_thumb.webp'
    ],
  ...
  },
  {
    ...
    price: 38.00,
    originalPrice: 48.00,
    imageUrl: '/images/products/bird_net_hdpe.webp',
    gallery: [
      '/images/products/bird_net_hdpe.webp',
      '/images/products/bird_net_hero.webp'
    ],
    category: 'Bird Net',
    colors: ['Black', 'White'],
    fabrics: ['HDPE'],
  ...
  },
  {
    ...
    price: 75.00,
    originalPrice: 95.00,
    imageUrl: '/images/products/mosquito_net_thumb.webp',
    gallery: [
      '/images/products/mosquito_net_thumb.webp',
      '/images/products/mosquito_net_hero.webp'
    ],
  ...
  },
  {
    ...
    price: 28.00,
    imageUrl: '/images/products/bird_net_nylon.webp',
    gallery: [
      '/images/products/bird_net_nylon.webp',
      '/images/products/bird_net_hero.webp'
    ],
    category: 'Bird Net',
  ...
  },
  {
    ...
    price: 110.00,
    imageUrl: '/images/products/aluminium_mesh_thumb.webp',
    gallery: [
      '/images/products/aluminium_mesh_thumb.webp',
      '/images/products/aluminium_mesh_hero.webp'
    ],
  ...
  },
  {
    ...
    imageUrl: '/images/products/zip_screen_hero.webp',
    gallery: [
      '/images/products/zip_screen_hero.webp',
      '/images/products/zip_screen_thumb.webp'
    ],
    category: 'Zip Screen',
    colors: ['Black', 'White', 'Silver'],
    fabrics: ['Polyester'],
  ...
  },
  {
    ...
    price: 45.00,
    originalPrice: 55.00,
    imageUrl: '/images/products/invisible_grill_track.webp',
    gallery: [
      '/images/products/invisible_grill_track.webp',
      '/images/products/invisible_grill_hero.webp'
    ],
    category: 'Invisible Grill',
    colors: ['Silver'],
  ...
  },
  {
    ...
    price: 90.00,
    imageUrl: '/images/products/invisible_grill_hero.webp',
    gallery: [
      '/images/products/invisible_grill_hero.webp',
      '/images/products/invisible_grill_thumb.webp'
    ],
  ...
  },
  {
    ...
    imageUrl: '/images/products/aluminium_mesh_hero.webp',
    gallery: [
      '/images/products/aluminium_mesh_hero.webp',
      '/images/products/aluminium_mesh_thumb.webp'
    ],
  ...
  },
  {
    ...
    price: 115.00,
    imageUrl: '/images/products/zip_screen_thumb.webp',
    gallery: [
      '/images/products/zip_screen_thumb.webp',
      '/images/products/zip_screen_hero.webp'
    ],
