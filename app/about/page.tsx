                ...
                <section className="py-12 pb-32">
                    <div className="container relative">
                        <div className="flex justify-center items-center relative min-h-[400px] md:min-h-[600px]">
                            ...
                            >
                                <Image src="/about_plant.webp" alt="Decor" fill className="object-cover rounded-[5px] shadow-custom-lg" />
                            </motion.div>
                            {/* Main Center Image */}
                            <motion.div
                            ...
                            >
                                <Image src="/about_sofa.webp" alt="Crafto Decor" fill className="object-cover rounded-[5px] shadow-custom-xl" />
                            </motion.div>
                            {/* Right Image */}
                            <motion.div
                                initial={{ opacity: 0, x: 50 }}
                            ...
                            >
                                <Image src="/about_studio.webp" alt="Design" fill className="object-cover rounded-[5px] shadow-custom-lg" />
                            </motion.div>
                        </div>
                    </div>
                </section>
