  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        {/* Page Title */}
        <PageTitle title="Bird Netting" mainTitle="Bird Control & Netting" />
              ...
              <div className="w-full lg:w-5/12 relative">
                <div className="relative aspect-[4/3] w-full shadow-custom-xl overflow-hidden rounded-[8px]">
                  <Image
                    ...
                    alt="Anti Bird Netting balcony protection"
                    fill
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 border border-border-custom rounded-[5px] shadow-custom-sm flex flex-col justify-between">
                <div>
                  <div className="relative h-48 w-full mb-6 rounded-[5px] overflow-hidden">
                    <Image src="/safe-net/images/products/bird_net_nylon.webp" alt="Residential Bird Netting" fill className="object-cover" />
                  </div>
                  <h3 className="text-xl font-bold text-primary uppercase tracking-wider mb-3">Residential Bird Netting</h3>
              ...
              <div className="bg-white p-8 border border-border-custom rounded-[5px] shadow-custom-sm flex flex-col justify-between">
                <div>
                  <div className="relative h-48 w-full mb-6 rounded-[5px] overflow-hidden">
                    <Image src="/safe-net/images/products/bird_net_hdpe.webp" alt="Industrial Bird Netting" fill className="object-cover" />
                  </div>
                  <h3 className="text-xl font-bold text-primary uppercase tracking-wider mb-3">Industrial Bird Netting</h3>
                  <p className="text-[14px] text-text-secondary leading-relaxed mb-6">
        ...
        <section className="py-24 bg-white">
          <div className="container">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight">Advantages of Our Netting</h2>
            </div>
